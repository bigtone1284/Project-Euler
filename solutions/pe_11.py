...
Note:  This is my first attempt at a grid/map-style problem and I used the work 
of Greg Gundersen to solve this problem.  
...
def get_grid():
	path = os.path.normpath(os.path.dirname(__file__) + "pe_11_grid.txt")
	f = open(path,'r')
